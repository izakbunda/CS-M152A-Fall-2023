...
HD_PWD='C:/Users/Student/izingnot/LAB2/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb1.tcl
